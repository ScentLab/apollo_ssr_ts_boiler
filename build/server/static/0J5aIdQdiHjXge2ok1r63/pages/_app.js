...
// CONCATENATED MODULE: ./ApolloClient/index.ts





var isProd = "undefined" === 'undefined';
var ApolloClient_createApolloClient = function createApolloClient() {
  var options = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {};

  var defalut = _objectSpread({}, options, {
  ...
  var client = new external_apollo_client_["ApolloClient"](isProd ? _objectSpread({}, defalut, {
    ssrMode: true
  }) : _objectSpread({}, defalut, {
...
var SITE_TITLE = 'apollo_ssr_ts_boilerplate';

var _app_App =
/*#__PURE__*/
function (_NextApp) {
  Object(inherits["default"])(App, _NextApp);

  function App() {
    Object(classCallCheck["default"])(this, App);

    return Object(possibleConstructorReturn["default"])(this, Object(getPrototypeOf["default"])(App).apply(this, arguments));
  }

  Object(createClass["default"])(App, [{
    key: "render",
    value: function render() {
      var _this$props = this.props,
          Component = _this$props.Component,
          pageProps = _this$props.pageProps;
      return external_react_default.a.createElement(app["Container"], null, external_react_default.a.createElement(head_default.a, null, external_react_default.a.createElement("title", null, SITE_TITLE), external_react_default.a.createElement("meta", {
        name: "viewport",
        ...
        client: ApolloClient_createApolloClient()
      }, external_react_default.a.createElement(external_react_["Fragment"], null, external_react_default.a.createElement(Component, pageProps))));
    }
  }]);
